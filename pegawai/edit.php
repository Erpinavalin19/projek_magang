...
<link rel="stylesheet" href="../css/edit_pegawai.css">
</head>
<body>
...
<ul>
<li class="#"><a href="halaman_pegawai.php">Home</a></li>
<li><a>//</a></li>
	...
	while($d = mysqli_fetch_array($data)){
		...
		<form method="post" action="update.php">
			<table>
				...
				<tr>
					<td>waktu</td>
					<td><input type="time" required name="waktu" value="<?php echo $d['waktu']; ?>"> SD <input type="time" required name="waktu" value="<?php echo $d['waktu']; ?>"></td>
				</tr>
				<tr>
					<td>Pengundang</td>
				...
				<td class="button"><input class="tombol" type="submit" value="SIMPAN"> <input class="tombol" type="reset" value="SEBELUMNYA">
				</td>
