...
<link rel="stylesheet" href="../css/pegawai_style.css">
</head>
<body>
...
<p>Selamat Datang</p>
<ul>
<li class="#"><a href="halaman_pegawai.php"><i class="fas fa-home"></i>	Home</a></li>
		...
		?>
			...
			<tr>
				...
				<td>
                    ...
                    <a href="hapus.php?id=<?php echo $d['id']; ?>"><i class="fas fa-eraser"></i></a>
				</td>
			</tr>
			<?php 
		}
